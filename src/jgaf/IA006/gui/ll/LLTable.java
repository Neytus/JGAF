...
{    
    ...
    public void addValue(TState state,TSymbol row, List<LLSymbol> cols)
    {
    ...
    public TSymbol getSymbolFor(LLSymbol s, Set<List<LLSymbol>> lfollow)
    {
        for(TSymbol ts : rows)
        {
    ...
    public TState getValueAtPosition(LLSymbol s, List<LLSymbol> prefix)
    {
